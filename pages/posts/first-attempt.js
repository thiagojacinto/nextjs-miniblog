    ...
    <Layout>
      <div className={styles.container}>
        ...
        <p className={styles.description}>
          ...
          <code className={styles.code}>pages/posts/first-attempt.js</code> and
          run it, you'll find a page already available at
        ...
        <p className={styles.description}>
          ...
          called <code className={styles.code}>styled-jsx</code> that does what
          is called means: applying css directly in JSX comeponents
